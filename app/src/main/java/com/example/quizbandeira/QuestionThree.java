...
public class QuestionThree extends AppCompatActivity {
    ...
    public void nextQuestion(View view){
        ...
        Intent forthQuestion = new Intent(getApplicationContext(), QuestionFour.class);

        forthQuestion.putExtra("USER_SCORE", player.getScore());
        forthQuestion.putExtra("USER_NAME", player.getName());
        startActivity(forthQuestion);
